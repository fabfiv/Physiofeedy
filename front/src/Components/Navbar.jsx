      ...
      <nav className="bg-gradient-to-r  from-[#011627] to-[#1B3B6F] px-4 lg:px-6 py-3">
        <div className="max-w-screen-xl mx-auto flex items-center justify-between">
          ...
          <div className="hidden lg:flex space-x-8 items-center">
            ...
            <Link to="/features" className="text-gray-300 hover:text-cyan-400 font-semibold transition duration-300">
              Features
            </Link>
            <Link to="/team" className="text-gray-300 hover:text-cyan-400 font-semibold transition duration-300">
              Team
            </Link>
